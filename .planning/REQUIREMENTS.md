...
- [x] **COST-02**: Labour is localized against published union rate cards (IATSE locals, SAG-AFTRA, DGA, WGA, BECTU, ACTRA)
...
- [x] **COST-08**: Multi-currency costs are converted via a dated FX rate carried as a cited figure
...
- [x] **OUT-03**: Sensitivity is displayed — which single input most moves the gap, shown as a delta and never as a prescriptive recommendation
...
- [x] **JUR-02**: California — validated model against the Film Commission approved projects list, with allocation-stage figures labelled as such
- [x] **JUR-03**: New Jersey — validated model against NJEDA activity reports, with estimated figures labelled as such
- [x] **JUR-04**: Connecticut — validated model against the Connecticut open data CSV
- [x] **JUR-05**: Adding a jurisdiction is additive — a new rule file, not changes to the engine

### Agentic Jobs

- [x] **AGT-01**: Job 1 ingests a published government disclosure document and extracts every production/award pair
...
- [x] **AGT-06**: Job 2 returns "no programme found" as a legitimate result rather than inventing one
...
- [x] **AGT-10**: The caching boundary is enforced at a single point: curated rules cached, while cap consumption, programme open/closed status, FX and uncurated-city research are live
- [x] **AGT-11**: Live research jobs have durable state and survive a process restart without hanging

### Interface

- [x] **UI-01**: A hosted URL prices a described production across named cities for an anonymous, unauthenticated visitor
- [x] **UI-02**: A map displays candidate cities coloured by total landed cost
- [x] **UI-03**: A start-date slider reorders the ranking live as it moves
- [x] **UI-04**: A ranked list shows net cost, incentive value, and when the cash arrives
...
- [x] **UI-10**: Live research shows informative progress and terminal error states, never a silent spinner that can time out
...
| COST-02 | Phase 4 — Cost Localization & Landed-Cost Outputs | 1 — Accounts | Complete |
...
| COST-08 | Phase 4 — Cost Localization & Landed-Cost Outputs | 1 — Accounts | Complete |
...
| OUT-03 | Phase 4 — Cost Localization & Landed-Cost Outputs | 1 — Accounts | Complete |
...
| JUR-04 | Phase 5 — Curated Breadth & the Validation Loop | 1 — Accounts | Complete |
| JUR-05 | Phase 2 — Engine Spine & Incentive Interpreter | 1 — Accounts | Complete |
| AGT-01 | Phase 5 — Curated Breadth & the Validation Loop | 1 — Accounts | Complete |
...
| AGT-06 | Phase 7 — Live Research, Caching & Durable Jobs | 1 — Accounts | Complete |
...
| AGT-10 | Phase 7 — Live Research, Caching & Durable Jobs | 1 — Accounts | Complete |
| AGT-11 | Phase 7 — Live Research, Caching & Durable Jobs | 1 — Accounts | Complete |
| UI-01 | Phase 6 — The Interface | 1 — Accounts | Complete |
| UI-02 | Phase 6 — The Interface | 1 — Accounts | Complete |
| UI-03 | Phase 6 — The Interface | 1 — Accounts | Complete |
| UI-04 | Phase 6 — The Interface | 1 — Accounts | Complete |
...
| UI-10 | Phase 7 — Live Research, Caching & Durable Jobs | 1 — Accounts | Complete |
