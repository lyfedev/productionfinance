...
- [x] **Phase 3: New York End-to-End — The Anora Proof** - The thinnest vertical slice: a real cited government figure reproduced on the hosted URL (completed 2026-08-25)
...
- [x] 03-03-PLAN.md — SHP-14: the declared mutation table, the five-step non-vacuity gate, and the sixth blocking CI job (wave 2)
...
- [x] 04-02-PLAN.md — Labour from dated union rate cards with fringe as its own line, plus the Los Angeles cost profile (COST-02, COST-03)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 04-03-PLAN.md — GSA per diem with its ceiling caveat, imported-crew housing and flights, shoot calendar and month-band seasonality (COST-04, COST-05, COST-07)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 04-04-PLAN.md — Stages, equipment, permits, locations and trucking as never-sourced estimates, plus stackable tax exemptions (COST-06, INC-10)

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 04-05-PLAN.md — Dated FX snapshot that refuses rather than cross-rates, and the London profile in GBP (COST-02, COST-08)

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 04-06-PLAN.md — Two-band ranked list, component-by-component gap decomposition, and golden cost totals in CI (OUT-01, OUT-02)
...
**Scope reversal (D-97, 05-CONTEXT.md, 2026-09-09)**: the earlier scope compression is VOID. Plans 05-01..05-03 delivered the eligibility spine and the New York proof (AGT-01, AGT-02, AGT-04, AGT-09, and SHP-06 pulled forward from Phase 7 per D-80 — Job 1 parses a government PDF, and Parallel Extract is the only permitted way to read one). The project owner has since rejected the cut: JUR-02, JUR-03, JUR-04 and AGT-08's complete four-guardrail set are **restored to this phase in full** and planned as 05-04..05-08. D-79 and D-88 are struck from 05-CONTEXT.md; no agent may cite either as grounds for omitting work. All five success criteria below are in scope.
**Success Criteria** (what must be TRUE):
...
**Plans**: 8/8 plans executed — 3 executed, 5 pending, in 3 further waves
...
- [x] 05-08-PLAN.md — Wire all four curated jurisdictions into `/validate`, carry disclosure stage through to the page, generalize the cross-jurisdiction sweep and add the four-jurisdiction acceptance gate (JUR-02, JUR-03, JUR-04)

**Cut line**: **VOID per D-97.** Connecticut was previously named the first cuttable item in Accounts; the project owner has rejected that cut. JUR-04 is delivered in full by 05-06 and 05-08.
...
- [x] 07-03-PLAN.md — Durable jobs: boot-id restart reclassification proven by a SIGKILL two-process test, and the round-by-round reasoning trail as a product surface (AGT-11, UI-10) (wave 2)
- [x] 07-04-PLAN.md — The caching boundary made real: one policy module, live FX with a visible fallback, live cap consumption and live programme status (AGT-10) (wave 2)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 07-05-PLAN.md — Same schema, identical engine: researched findings coerced to a rule file, loaded by `load_ruleset`, priced by `price_jurisdiction`, labelled researched (AGT-07, AGT-05) (wave 3)
...
| 8. Demo Proof, Export & Submission | 1 — Accounts | 3/3 | In Progress|  |
